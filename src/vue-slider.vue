...
document.onmousedown = function(ev){
	var oEvent = ev || event;   
	disX = oEvent.clientX - leftBtn.offsetLeft;    //鼠标横坐标点到div的offsetLeft距离
	document.onmousemove = function (ev) {
		...
		else if (l > document.documentElement.clientWidth - leftBtn.offsetWidth) {
					l = document.documentElement.clientWidth - leftBtn.offsetWidth;
		}
		leftBtn.style.left = l +'px';
...
import white from './assets/white.png'
	export default {
		...
		mounted(){
			...
			// 	let pageX = e.clientX-mySliderX //获取滑动x坐标
			...
			// mySlider.addEventListener('onmousedown',(e)=>{//屏幕触摸事件
			// 	let touchX = e.clientX-mySliderX
